      ...
      <section className="section">
        <div className="container">
          ...
          <div id="japan" className="dest-section">
            <div className="dest-img-container" style={{ position: 'relative', width: '100%', maxWidth: '400px', height: '300px' }}>
              <Image 
            ...
            <div className="dest-content">
              ...
              <div className="benefits-grid">
                ...
                <ul>
                  <li><strong>Work Permit:</strong> Legal authorization to work under the "Permission to Engage in Activity other than that Permitted under the Status of Residence".</li>
                  <li><strong>Term-Time Work:</strong> Up to 28 hours per week.</li>
                  <li><strong>Holiday Work:</strong> Up to 40 hours per week (8 hours per day) during summer and winter breaks.</li>
                  <li><strong>Competitive Wages:</strong> Hourly earnings that significantly offset tuition and living costs.</li>
                  <li><strong>Scholarship Access:</strong> Availability of government (MEXT) and private financial aid.</li>
                  <li><strong>Path to Residency:</strong> Simplified visa pathways for high-skilled international graduates.</li>
                  <li><strong>Vocational Excellence:</strong> Practical training at Senmon Gakkou focused on immediate employability.</li>
                  <li><strong>High Job Placement:</strong> Direct access to career opportunities in major global tech hubs.</li>
                  <li><strong>Safety:</strong> One of the lowest crime rates globally, ensuring a secure environment for solo and family life.</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div id="uk" className="dest-section">
            ...
            <div className="dest-content">
              ...
              <div className="benefits-grid">
                <h4>Key Parameters & Benefits</h4>
                <ul>
                  <li><strong>Graduate Route Visa:</strong> Stay and build your career in the UK for at least two years after graduation.</li>
                  <li><strong>Part-Time Work:</strong> Balance studies and gain local experience by working up to 20 hours per week during the term.</li>
                  <li><strong>Full-Time Holiday Work:</strong> Freedom to work full-time during university breaks.</li>
                  <li><strong>Shorter Degree Durations:</strong> Many Master’s programs are completed in just one year, saving on costs.</li>
                  <li><strong>Global Recognition:</strong> A degree from a UK institution is a powerful credential respected globally.</li>
                  <li><strong>Vast Career Prospects:</strong> Massive, diverse job market spanning financial, tech, and creative industries.</li>
                  <li><strong>Academic Excellence:</strong> World-renowned for innovation, research, and high educational benchmarks.</li>
                  <li><strong>Cultural Diversity:</strong> Grow personally while building a global network in a multicultural environment.</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div id="finland" className="dest-section">
            ...
            <div className="dest-content">
              ...
              <div className="benefits-grid">
                <h4>Key Parameters & Benefits</h4>
                <ul>
                  <li><strong>Post-Study Work Visa:</strong> Apply for a permit for up to one year after graduation to find a job.</li>
                  <li><strong>Part-Time Work:</strong> Flexibility to work and gain local experience while you study.</li>
                  <li><strong>Safety and Security:</strong> Exceptionally low crime rates and advanced emergency systems.</li>
                  <li><strong>English-Taught Programs:</strong> Diverse range of courses taught entirely in English.</li>
                  <li><strong>Affordable Quality:</strong> High-standard teaching at a more affordable total cost.</li>
                  <li><strong>Scenic & Healthy Lifestyle:</strong> Famous for pristine forests, lakes, and the Northern Lights.</li>
                  <li><strong>Global Career Recognition:</strong> Valued for practical learning and innovative problem-solving skills.</li>
                  <li><strong>Inclusive Environment:</strong> Warm welcome and strong support network from an international community.</li>
                </ul>
              </div>
            </div>
          </div>
